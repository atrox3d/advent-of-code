...
in strings. 
For example, C, JavaScript, Perl, Python, and even PHP handle special characters in 
very similar ways.
...
string literals minus the number of characters in memory for the values of the strings in 
